        ...
        <div className="flex max-w-screen-sm lg:max-w-screen-lg xl:max-w-screen-xl w-full mx-auto justify-center mt-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 w-full h-fit gap-4">
            ...
            {organizationsData.map((organization) => (
              <div
                key={organization.id}
                className="py-4 px-5 border border-gray-300 hover:border-gray-400 transition-all duration-200 ease-linear shadow-sm hover:shadow-md rounded-xl flex flex-col justify-between"
              >
